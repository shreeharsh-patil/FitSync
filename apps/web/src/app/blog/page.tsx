...
const posts = [
  {
    ...
    excerpt:
      "Learn how to systematically increase the stress on your body to achieve consistent gains without hitting a plateau.",
    category: "Workouts",
  ...
  },
  {
    ...
    excerpt:
      "Diving deep into how fats and carbohydrates play a crucial role in your athletic performance and hormonal health.",
    category: "Nutrition",
    author: "Markus Vane",
    date: "May 12, 2026",
  ...
  },
  {
    ...
    excerpt:
      "How to build the mental toughness required to push through the most demanding sessions and stay consistent.",
  ...
  },
  {
    ...
    excerpt:
      "Quick, delicious, and nutrient-dense recipes that fit into even the most crowded schedules.",
    category: "Recipes",
    author: "Chef Julian",
    date: "May 08, 2026",
    readTime: "5 min read",
      ...
      <main className="flex-1 container px-4 md:px-6 py-12 md:py-24 space-y-16">
        ...
        <div className="flex flex-col items-center text-center space-y-6 max-w-3xl mx-auto">
          ...
          <p className="text-muted-foreground text-lg md:text-xl">
            Expert insights on training, nutrition, and the science of human
            performance.
          </p>
          ...
          {categories.map((cat) => (
            <Button
              ...
              className={cn(
                ...
                cat === "All"
                  ? "text-primary shadow-lg shadow-secondary/10"
                  : "hover:bg-white/5",
              )}
            >
              {cat}
        ...
        <div className="flex justify-center pt-12">
          <Button
            variant="outline"
            className="border-white/5 hover:bg-white/5 font-bold uppercase tracking-widest px-8 h-14 rounded-2xl"
          >
            Load More Articles
          </Button>
        </div>
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        featured &&
          "md:col-span-2 lg:col-span-2 md:flex-row md:space-y-0 md:gap-8",
      )}
    >
      <div
        className={cn(
          "aspect-[16/9] bg-muted rounded-[2rem] relative overflow-hidden",
          featured ? "md:w-3/5" : "w-full",
        )}
      >
      ...
      <div
        className={cn(
          ...
          featured ? "md:w-2/5 md:justify-center" : "pt-2",
        )}
      >
        ...
        <h3
          className={cn(
            "font-bold font-heading group-hover:text-secondary transition-colors leading-tight",
            featured ? "text-3xl" : "text-xl line-clamp-2",
          )}
        >
          {title}
        </h3>
