...
import { ArrowRight, Activity, Zap, Users, Brain, Shield, Trophy, Smartphone } from "lucide-react"
    ...
    <div className="flex flex-col min-h-screen bg-background overflow-hidden selection:bg-secondary selection:text-primary">
      ...
      <header className="px-6 lg:px-12 h-20 flex items-center border-b border-white/5 sticky top-0 bg-background/80 backdrop-blur-xl z-50">
        ...
        <nav className="ml-auto hidden md:flex gap-8">
          ...
          <Link className="text-sm font-bold uppercase tracking-widest hover:text-secondary transition-colors" href="/blog">
            Blog
          </Link>
        </nav>
        ...
        <section className="w-full py-20 md:py-32 lg:py-48 flex flex-col items-center justify-center relative">
          ...
          <div className="container px-4 md:px-6 flex flex-col items-center text-center space-y-12 relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <Link href="/signup">
                <Button size="lg" className="bg-accent hover:bg-accent/90 text-white px-10 h-16 text-lg font-bold shadow-2xl shadow-accent/20 transition-all hover:scale-105 active:scale-95">
                  Start Your Journey
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Link href="#features">
                <Button size="lg" variant="outline" className="border-white/10 hover:bg-white/5 h-16 px-10 text-lg font-bold transition-all">
                  Explore Ecosystem
                </Button>
              </Link>
            </div>
            ...
            <div className="pt-12 flex flex-col items-center gap-6">
              <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-muted-foreground">Trusted by 500,000+ athletes</p>
        ...
        <section id="features" className="w-full py-24 md:py-32 relative overflow-hidden">
          ...
          <div className="container px-4 md:px-6 relative z-10">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-20">
              <h2 className="text-4xl font-bold tracking-tight sm:text-6xl font-heading">Engineered for <span className="text-secondary">Peak Performance</span></h2>
              <p className="max-w-[800px] text-muted-foreground text-lg md:text-xl">
                FitSync combines elite-level data tracking with human-centric design.
              </p>
            </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="glass p-12 md:p-24 rounded-[3rem] border-white/10 flex flex-col items-center justify-center space-y-8 text-center relative overflow-hidden group">
              ...
              <div className="relative z-10 space-y-4">
                <h2 className="text-4xl font-bold tracking-tight sm:text-7xl font-heading leading-tight">Ready to Level Up Your <br /> <span className="text-secondary">Fitness DNA?</span></h2>
                ...
                <div className="pt-8">
                  <Link href="/signup">
                    <Button size="lg" className="bg-secondary hover:bg-secondary/90 text-primary font-bold px-12 h-16 text-xl rounded-2xl shadow-2xl shadow-secondary/20 transition-all hover:scale-105">
  ...
  return (
    <div className="glass p-8 rounded-[2rem] border-white/5 flex flex-col items-start text-left space-y-6 transition-all hover:bg-white/5 hover:border-white/10 hover:-translate-y-2 group cursor-default">
      ...
      <div className="space-y-2">
        <h3 className="text-xl font-bold font-heading group-hover:text-secondary transition-colors">{title}</h3>
