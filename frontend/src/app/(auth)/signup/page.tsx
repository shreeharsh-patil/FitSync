    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-surface-0">
        <div className="w-full max-w-sm">
          ...
          {error && (
            <div className="mb-5 p-3 bg-danger/10 border border-danger/20 rounded-lg text-xs flex items-start gap-2 text-danger">
              <AlertCircle className="h-4 w-4 shrink-0 mt-px" /><span>{error}</span>
            </div>
          )}
          {success && (
            <div className="mb-5 p-3 bg-success/10 border border-success/20 rounded-lg text-xs flex items-start gap-2 text-success">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-3">
              <div>
                <label htmlFor="name" className="text-xs font-semibold text-text-secondary mb-1.5 block">Full name</label>
              ...
              <div>
                <label htmlFor="password" className="text-xs font-semibold text-text-secondary mb-1.5 block">Password</label>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button type="button" disabled
              className="flex items-center justify-center gap-2 h-10 border border-border rounded-lg text-xs font-medium text-text-muted/50 cursor-not-allowed opacity-50">
          ...
          <p className="text-sm text-text-secondary text-center mt-8">
            ...
            <Link href="/login" className="font-semibold text-accent hover:text-accent-hover transition-colors">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
