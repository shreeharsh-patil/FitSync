  ...
  return (
    <div className="space-y-8">
      <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <h1 className="text-3xl md:text-4xl font-black font-[family-name:var(--font-display)] tracking-tighter text-text-primary">Preferences</h1>
        ...
        <div className="lg:col-span-3 space-y-6">
          {activeSection === "profile" && (
            <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
              <div className="rounded-lg bg-surface-2 border border-border p-6 md:p-8 space-y-6">
                <h2 className="text-lg font-black font-[family-name:var(--font-display)] text-text-primary">Profile Information</h2>
              ...
              <div className="rounded-lg bg-surface-2 border border-border p-6 md:p-8 space-y-4">
                <h2 className="text-lg font-black font-[family-name:var(--font-display)] text-text-primary">Integrations</h2>
          ...
          {activeSection === "notifications" && (
            <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}
              ...
              <h2 className="text-lg font-black font-[family-name:var(--font-display)] text-text-primary">Notification Preferences</h2>
          ...
          {activeSection === "privacy" && (
            <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}
              className="rounded-lg bg-surface-2 border border-border p-6 md:p-8 space-y-6">
              <h2 className="text-lg font-black font-[family-name:var(--font-display)] text-text-primary">Privacy & Security</h2>
          ...
          {activeSection === "billing" && (
            <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}
              className="rounded-lg bg-surface-2 border border-border p-6 md:p-8 space-y-6">
              <h2 className="text-lg font-black font-[family-name:var(--font-display)] text-text-primary">Billing & Subscription</h2>
