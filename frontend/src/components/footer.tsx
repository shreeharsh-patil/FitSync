...
const getFooterLink = (section: string, label: string) => {
...
export function Footer() {
  ...
  const footerLinks = [
    {
      title: "Product",
      links: ["AI Coach", "Workouts", "Nutrition", "Community"],
    },
    {
      title: "Quick Links",
      links: ["Home", "Features", "Community", "Pricing"],
    },
    {
      title: "Company",
    ...
    <footer ref={footerRef} id="contact" className="relative bg-[#121212] pt-16 pb-6 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          >
            Join 50k+ athletes. No spam, just gains.
          </motion.p>
        </motion.div>
        ...
        >
          <p className="text-white/60 font-mono text-xs max-w-xl mx-auto leading-relaxed">
            FitSync is an AI-powered fitness platform that unifies your workouts, nutrition, and coaching
            into one seamless experience. Train smarter, recover faster.
          </p>
        </motion.div>
                ...
                {section.links.map((item) => (
                  <li key={item}>
                    <motion.div whileHover={{ x: 4 }} transition={{ type: "spring", stiffness: 400, damping: 17 }}>
                      <Link
                        href={getFooterLink(section.title, item)}
        ...
        >
          ...
          <p className="text-white/40 font-mono text-xs">© 2026 FitSync. All rights reserved.</p>
