...
const lifestyleImages = [
  { src: "/community_yoga.png", aspect: "portrait" },
  { src: "/community_running.png", aspect: "landscape" },
  { src: "/community_smartwatch.png", aspect: "square" },
  { src: "/community_crossfit.png", aspect: "landscape" },
  { src: "/community_lifting.png", aspect: "portrait" },
  { src: "/community_nutrition.png", aspect: "square" },
]

const socialPosts = [
  { handle: "@creativekatie", text: "FitSync got me through my entire album production. No cap 🔥", likes: "2.4k" },
  { handle: "@fitnessjay", text: "FitSync completely transformed how I train. The AI coach knows me better than I do.", likes: "1.8k" },
  { handle: "@techbro_sam", text: "Finally a fitness app that actually adapts to my schedule. Game changer.", likes: "956" },
]
