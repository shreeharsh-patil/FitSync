...
const activations = [
  ...
  },
  {
    ...
    description: "500+ exercises with real-time form tracking.",
    cta: "Start Training",
  },
  {
    icon: Building2,
    title: "Nutrition Hub",
    description: "Track macros, meals, and hydration in seconds.",
    cta: "Track Meals",
  },
  {
    icon: Calendar,
    title: "Community",
    description: "Join challenges, compete on leaderboards, connect.",
    cta: "Join Community",
  },
]
    ...
    <section id="features" className="relative py-16 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          >
            From AI coaching to community challenges, FitSync powers your entire fitness journey.
          </motion.p>
        </motion.div>
