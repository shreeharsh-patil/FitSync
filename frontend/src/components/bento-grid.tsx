...
const features = [
  ...
  },
  {
    ...
    title: "500+",
    subtitle: "Exercises",
    description: "From bodyweight to advanced lifting",
    accent: "#FF6B35",
  },
  {
    icon: Brain,
    ...
    description: "Workouts, nutrition, sleep & more",
    accent: "#00D4FF",
  },
  {
    icon: Sparkles,
    ...
    description: "Log meals in seconds with precision",
    accent: "#AFFF00",
  },
]
...
export function BentoGrid() {
  ...
  return (
    <section id="highlights" className="relative py-16 bg-[#121212] overflow-hidden">
