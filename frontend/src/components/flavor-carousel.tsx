...
const features = [
  {
    ...
    description: "Personalized workout plans that adapt to your progress and recovery.",
    image: "/model.png",
  ...
  },
  {
    id: 2,
    name: "Nutrition Hub",
    tagline: "Precision Fuel",
    description: "Track macros, meals, and hydration with the largest food database.",
    image: "/model.png",
  ...
  },
  {
    ...
    name: "Community",
    tagline: "Coming Soon",
    description: "Challenges, leaderboards, and a global fitness community.",
    image: "/model.png",
...
export function FeatureCarousel() {
  ...
  const nextFeature = () => paginate(1)
  const prevFeature = () => paginate(-1)
        ...
        <div className="relative">
          <div className="flex items-center justify-center gap-6">
            ...
            <AnimatePresence mode="wait" custom={direction}>
              ...
              >
                <motion.div
                  className={`bg-white rounded-3xl p-6 md:p-8 border-2 border-[#121212]/10 shadow-xl ${currentFeature.comingSoon ? "relative overflow-hidden" : ""}`}
                  ...
                  <div className="grid md:grid-cols-2 gap-6 items-center">
                    ...
                    >
                      <Image
                        ...
                        fill
                        className={`object-contain ${currentFeature.comingSoon ? "blur-sm grayscale" : ""}`}
                      />
                      {currentFeature.comingSoon && (
                        <motion.div
                    ...
                    <div className="space-y-4">
                      ...
                      {!currentFeature.comingSoon && (
                        ...
                        >
                          {["AI-Powered", "Adaptive Plans", "Track Progress", "Community"].map((badge) => (
                            <span
                              key={badge}
                      ...
                      {!currentFeature.comingSoon && (
                        <motion.button
                          ...
                          whileTap={{ scale: 0.98 }}
                          transition={{ type: "spring", stiffness: 400, damping: 17 }}
                          style={{ backgroundColor: currentFeature.accentColor, color: "#121212" }}
                          initial={{ opacity: 0, y: 20 }}
                          animate={{ opacity: 1, y: 0 }}
                        >
                          <motion.span
                      ...
                      {currentFeature.comingSoon && (
                        ...
                        >
                          ...
                          />
                          <span className="font-mono text-xs text-[#121212]/60">Launching soon...</span>
                        </motion.div>
                      )}
                    </div>
                  </div>
          ...
          <div className="flex justify-center gap-2 mt-6">
            {features.map((feature, index) => (
              <motion.button
                ...
                style={{
                  backgroundColor: index === currentIndex ? feature.accentColor : "#12121220",
                }}
                animate={{
