...
const instagramPosts = [
  { image: "/community_lifting.png", likes: "2.4k" },
  { image: "/community_running.png", likes: "3.1k" },
  { image: "/community_yoga.png", likes: "1.8k" },
  { image: "/community_smartwatch.png", likes: "956" },
  { image: "/community_nutrition.png", likes: "1.5k" },
  { image: "/community_crossfit.png", likes: "2.1k" },
]
  ...
  return (
    <section id="community" className="relative py-16 bg-[#121212] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <motion.a
            href="https://instagram.com/fitsync"
            target="_blank"
          ...
          >
            ...
            />
            <svg className="w-4 h-4 relative z-10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
            <span className="relative z-10">Follow @fitsync</span>
          </motion.a>
        </motion.div>
      </div>
    </section>
