        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <motion.div style={{ opacity }} className="space-y-5">
            ...
            <div className="space-y-1 overflow-hidden">
              ...
              >
                Sync your body, sync your life. AI-powered fitness tracking.
              </motion.p>
            </div>
            ...
            >
              {["AI Coach", "Smart Workouts", "Nutrition Tracking", "Community"].map((benefit, i) => (
                <motion.div
                  key={benefit}
          ...
          <motion.div style={{ y, scale }} className="relative flex justify-center">
            <motion.div variants={scaleInVariants} initial="hidden" animate="visible" className="relative">
              ...
              >
                <Image
                  src="/model.png"
                  alt="FitSync - AI-Powered Fitness Platform"
                  width={350}
                  height={525}
